...
// Some type shortcuts
typedef CustomRobot1::State<T> State;
typedef CustomRobot1::Control<T> Control;
typedef CustomRobot1::SystemModel<T> SystemModel;

typedef CustomRobot1::PositionMeasurement<T> PositionMeasurement;
typedef CustomRobot1::OrientationMeasurement<T> OrientationMeasurement;
typedef CustomRobot1::PositionMeasurementModel<T> PositionModel;
typedef CustomRobot1::OrientationMeasurementModel<T> OrientationModel;
...
//    T distanceNoise = 0.25;
    ...
    for(size_t i = 1; i <= N; i++)
    {
        ...
        Kalman::Vector<T, 3> system_noise;
        system_noise << systemNoise*noise(generator),
                        systemNoise*noise(generator),
                        systemNoise*noise(generator);
