...
public:
    ...
    typedef  KalmanExamples::CustomRobot1::PositionMeasurement<T> M;
...
protected:
    ...
    void updateJacobians( const S& x )
    {
        ...
        this->H( M::D1, 0 ) = delta1[0] / d1;
        // partial derivative of meas.d1() w.r.t. x.y()
        this->H( M::D1, 1 ) = delta1[1] / d1;
        
        // partial derivative of meas.d1() w.r.t. x.x()
        this->H( M::D2, 0 ) = delta2[0] / d2;
        // partial derivative of meas.d1() w.r.t. x.y()
        this->H( M::D2, 1 ) = delta2[1] / d2;
    }
};
